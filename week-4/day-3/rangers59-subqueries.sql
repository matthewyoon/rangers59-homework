...
-- LEFT JOIN on the Customer and Payment Tables
...
-- FULL JOIN that will produce info about a customer - MULTIJOIN
...
-- Basic Subquery happens within the "IN( )" within the parentheses
SELECT *
FROM customer
